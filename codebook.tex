...
\fancyhead[L]{National Taiwan Ocean University Enter}
\fancyhead[R]{\thepage}
...
\subsection{極角排序}
\lstinputlisting{geometry/pt_sort.cpp}
...
\subsection{Min Mean Cycle 最小平均數環}
...
\subsection{LCS to LIS}
\lstinputlisting{string/LCS_to_LIS.cpp}
